## xcodebuild exit status: 0 (run #29, commit 6276fa11605cd7e74f30913e1163f65672f17d40)
...
ios/FirasAI/Features/Code/CodeGitHubModel.swift:323:48: warning: main actor-isolated static property 'linksKey' can not be referenced from a nonisolated context; this is an error in the Swift 6 language mode
...
ios/FirasAI/Features/Shell/CompactDrawer.swift:362:17: warning: '@preconcurrency' on conformance to 'UIGestureRecognizerDelegate' has no effect
ios/FirasAI/Features/Voice/AudioSessionArbiter.swift:113:61: warning: 'allowBluetooth' was deprecated in iOS 8.0: renamed to 'AVAudioSession.CategoryOptions.allowBluetoothHFP'
ios/FirasAI/Features/Voice/AudioSessionArbiter.swift:126:28: warning: 'allowBluetooth' was deprecated in iOS 8.0: renamed to 'AVAudioSession.CategoryOptions.allowBluetoothHFP'
...
ios/FirasAI/Rendering/MarkdownView.swift:109:13: warning: no 'async' operations occur within 'await' expression
ios/FirasAI/Rendering/MathBlockView.swift:71:55: warning: no 'async' operations occur within 'await' expression
ios/FirasAI/Rendering/MathIsland.swift:285:14: warning: consider using asynchronous alternative function
ios/FirasAI/Rendering/MathIsland.swift:294:18: warning: consider using asynchronous alternative function
ios/FirasAI/Rendering/MathIsland.swift:659:21: warning: '@preconcurrency' on conformance to 'WKNavigationDelegate' has no effect
ios/FirasAI/Rendering/MathIsland.swift:659:21: warning: '@preconcurrency' on conformance to 'WKScriptMessageHandler' has no effect
...
ios/FirasAI/Stores/CodeStore+Project.swift:252:47: warning: main actor-isolated static property 'taskCharacterCap' can not be referenced from a nonisolated context; this is an error in the Swift 6 language mode
ios/FirasAI/Stores/CodeStore+Project.swift:254:58: warning: main actor-isolated static property 'attachmentCharacterCap' can not be referenced from a nonisolated context; this is an error in the Swift 6 language mode
ios/FirasAI/Stores/CodeStore+Project.swift:368:85: warning: main actor-isolated static property 'taskCharacterCap' can not be referenced from a nonisolated context; this is an error in the Swift 6 language mode
ios/FirasAI/Stores/CodeStore+Project.swift:370:51: warning: main actor-isolated static property 'planAttachmentLimit' can not be referenced from a nonisolated context; this is an error in the Swift 6 language mode
ios/FirasAI/Stores/CodeStore+Project.swift:409:35: warning: main actor-isolated static property 'fileBriefLimit' can not be referenced from a nonisolated context; this is an error in the Swift 6 language mode
ios/FirasAI/Stores/CodeStore+Project.swift:411:51: warning: main actor-isolated static property 'fileAttachmentLimit' can not be referenced from a nonisolated context; this is an error in the Swift 6 language mode
```
...
ios/FirasAI/Stores/CodeStore+Project.swift:159:47: warning: main actor-isolated static property 'nameCharacterCap' can not be referenced from a nonisolated context; this is an error in the Swift 6 language mode
        let name = String(project.name.prefix(nameCharacterCap))
                                              ^
ios/FirasAI/Stores/CodeStore.swift:140:16: note: static property declared here
    static let nameCharacterCap = 80
               ^
ios/FirasAI/Stores/CodeStore+Project.swift:252:47: warning: main actor-isolated static property 'taskCharacterCap' can not be referenced from a nonisolated context; this is an error in the Swift 6 language mode
        var task = String(ticket.brief.prefix(taskCharacterCap))
                                              ^
ios/FirasAI/Stores/CodeStore.swift:137:16: note: static property declared here
    static let taskCharacterCap = 6_000
               ^
ios/FirasAI/Stores/CodeStore+Project.swift:254:58: warning: main actor-isolated static property 'attachmentCharacterCap' can not be referenced from a nonisolated context; this is an error in the Swift 6 language mode
            task += "\n\n" + String(ticket.attach.prefix(attachmentCharacterCap))
                                                         ^
ios/FirasAI/Stores/CodeStore.swift:138:16: note: static property declared here
...
ios/FirasAI/Stores/CodeStore+Project.swift:370:51: warning: main actor-isolated static property 'planAttachmentLimit' can not be referenced from a nonisolated context; this is an error in the Swift 6 language mode
            user += "\n\n" + String(attach.prefix(planAttachmentLimit))
                                                  ^
ios/FirasAI/Stores/CodeStore.swift:144:16: note: static property declared here
    static let planAttachmentLimit = 6_000
               ^
ios/FirasAI/Stores/CodeStore+Project.swift:409:35: warning: main actor-isolated static property 'fileBriefLimit' can not be referenced from a nonisolated context; this is an error in the Swift 6 language mode
            + String(brief.prefix(fileBriefLimit))
                                  ^
ios/FirasAI/Stores/CodeStore.swift:145:16: note: static property declared here
    static let fileBriefLimit = 4_000
               ^
ios/FirasAI/Stores/CodeStore+Project.swift:411:51: warning: main actor-isolated static property 'fileAttachmentLimit' can not be referenced from a nonisolated context; this is an error in the Swift 6 language mode
            user += "\n\n" + String(attach.prefix(fileAttachmentLimit))
                                                  ^
ios/FirasAI/Stores/CodeStore.swift:146:16: note: static property declared here
...
2026-09-03 05:10:39.959 appintentsnltrainingprocessor[14530:43535] Parsing options for appintentsnltrainingprocessor
2026-09-03 05:10:39.960 appintentsnltrainingprocessor[14530:43535] Starting AppIntents SSU YAML Generation
2026-09-03 05:10:39.972 appintentsnltrainingprocessor[14530:43535] No AppShortcuts found - Skipping.
