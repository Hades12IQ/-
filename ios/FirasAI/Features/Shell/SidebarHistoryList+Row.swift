...
/// `[new]` — the web has no all-chats page and no relative timestamps in its sidebar, so this copy
/// is native. It lives with the row that reads it rather than in `Strings+Shell.swift`, which
/// another batch owns.
