...
extension Strings {
    ...
    enum CodeUI {
        ...
        // MARK: - Session composer (owner report round 2)
        //
        // The session screen is a conversation with a composer, not a form: the calm empty state
        // asks one question and the composer carries the context (model, repository) as pills.

        static let sessionEmptyTitle = LText(ar: "من أين نبدأ؟", en: "Where should we start?")
        static let sessionEmptyBody = LText(
            ar: "اكتب ما تريد بناءه أو تعديله، ويتكفّل فِراس بالباقي.",
            en: "Describe what you want built or changed, and Firas takes it from there."
        )
        static let composerPlaceholder = LText(
            ar: "اكتب ما تريد بناءه أو تعديله…",
        ...
        static let sendLabel = LText(ar: "إرسال", en: "Send")
        static let buildingFirst = LText(ar: "يبني مشروعك الآن…", en: "Building your project…")
