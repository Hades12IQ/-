...
struct MediaTile: View {
    ...
    var body: some View {
        Button {
            // A tile that is still rendering has nothing to show full screen yet; the long press
            // still works, which is where regenerate and remove live.
            guard !creation.phase.isLive else { return }
            Haptics.select()
