...
final class AgentStore: JobObserver {
    ...
    private func launch(
        ...
        // The deliverables of the mission this one continues. Read before the record below
        // replaces it, which is why it is taken here and not at the fold.
        let previousFiles = missions[conversationID]?.surface?.files ?? []
