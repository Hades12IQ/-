...
extension SendPipeline {
    ...
    func runTurn(_ context: ChatTurnContext, assistantID: String) async {
        ...
        // recovering it later is exactly what must not be possible in a temporary chat. The plain
        // stream below carries the same messages to the same model and leaves neither.
