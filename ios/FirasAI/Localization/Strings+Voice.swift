...
extension Strings {
    ...
    enum Voice {
        ...
        /// New for iOS: the four seconds the repair turn spends reading the finished transcript
        /// back — fixing mis-hearings and putting Arabic words that came back in Latin letters
        /// into Arabic script. The words are already on screen while this is showing; the line
        /// only says the sentence may still correct itself once.
        static let micPolishing = LText(ar: "جارٍ تدقيق النص…", en: "Tidying up the text…")
