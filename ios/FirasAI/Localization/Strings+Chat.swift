...
extension Strings {
    enum Chat {
        ...
        /// A turn that finished with nothing in it. Never silent: an invisible empty answer
        /// is indistinguishable from a deleted one.
        static let emptyAnswer = LText(
            ar: "انتهى الدور بلا جواب. جرّب مرّة أخرى.",
            en: "The turn finished with no answer. Try again."
        )
