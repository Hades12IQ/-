...
"""##
    ...
    static let tierPro: TierInfo = TierInfo(key: "pro", labelAr: "فِراس برو", labelEn: "Firas Pro", taglineAr: "متوازن وذكي", taglineEn: "Balanced & smart", shortAr: "برو", shortEn: "Pro", reasoningEffort: "low", temperature: 0.6, maxTokens: 16384, showThinking: true, premium: false, persona: personaPro)
