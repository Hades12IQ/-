    ...
    (function () {
      ...
      window.firasRun = function (payload) {
        try {
          ...
          /* NO GROUND AT ALL. An opaque snapshot carries its background into every
             surface it is later drawn on, and this app has three of them — a grained
             transcript, a flat card, a white page. Transparent is the only value that
             is right on all three. */
